...
--
-- Host: 127.0.0.1    Database: son_python_db_api_pratica
-- ------------------------------------------------------
...
INSERT INTO `agencies` VALUES (1,'1111','rua x'),(2,'2222','rua y');
...
CREATE TABLE `bank_accounts` (
  ...
  KEY `fk_bank_accounts_users1_idx` (`user_id`),
  ...
  CONSTRAINT `fk_bank_accounts_users1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `bank_accounts` VALUES (1,'0001-01','123456',380.00,1,1),(2,'0002-02','123456',1000.00,1,2),(3,'0003-03','123456',2000.00,2,3),(4,'1111-11','123456',10000.00,2,4);
...
INSERT INTO `cash_machines` VALUES (1,'caixa eletronico 1'),(2,'caixa eletronico 2');
...
CREATE TABLE `money_slips` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_money_bill_cash_machine` (`money_bill`,`cash_machine_id`),
...
INSERT INTO `money_slips` VALUES (1,20,39,1),(2,50,999,1),(3,100,20,1),(4,20,10,2),(5,50,10,2),(6,100,10,2);
...
INSERT INTO `users` VALUES (1,'Fulano','fulano@schoolofnet.com','rua do fulano',0),(2,'Beltrano','beltrano@schoolofnet.com','rua do beltrano',0),(3,'Cicrano','cicrano@schoolofnet.com','rua do cicrano',0),(4,'Gerente','gerente@schoolofnet.com','rua do gerente',1);
...
-- Dump completed on 2018-04-15 18:59:20
